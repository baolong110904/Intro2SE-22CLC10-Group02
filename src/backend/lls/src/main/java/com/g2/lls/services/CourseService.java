...
public interface CourseService {
    CourseResponse createCourse(CourseDTO courseDTO, String email) throws Exception;
    List<CourseResponse> getAllCourses(CourseFilterDTO courseFilterDTO, String email) throws Exception;
    CourseResponse getCourseById(Long id) throws Exception;
    void deleteCourse(Long id, String email) throws Exception;
    CourseResponse updateCourse(Long id, UpdateCourseDTO courseDTO, String email) throws Exception;
    List<CourseResponse> addStudent(List<Long> courseIds, String email, Long orderId) throws Exception;
    CourseResponse removeStudent(Long id, Long studentId, String email) throws Exception;
