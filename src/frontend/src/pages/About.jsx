...
const About = () => {
  ...
  return (
    <div
      className="md:px-14 p-4 max-w-s mx-auto dark:bg-darkBg"
      ref={aboutRef}
      id="about"
    >
              ...
              <section className="grid gap-12 md:grid-cols-3 md:gap-16">
                ...
                <article className="dark:bg-darkCard dark:text-darkText p-4 rounded shadow-md">
                  ...
                  <h2>
                    ...
                    <span className="text-xl inline-flex font-semibold bg-clip-text text-transparent bg-gradient-to-r from-blue-800 to-blue-400 mb-2">
                      Languages
                    </span>
                  </h2>

                  <p className="text-slate-500 dark:text-darkText">
                    There are over 20 languages with a variety of courses for
                    learners to use.
                  </p>
                </article>
                {/* Block #2 */}
                <article className="dark:bg-darkCard dark:text-darkText p-4 rounded shadow-md">
                  ...
                  <h2>
                    ...
                    <span className="text-xl inline-flex font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-800 to-blue-400 mb-2">
                      Courses
                    </span>
                  </h2>

                  <p className="text-slate-500 dark:text-darkText">
                    A broad selection of courses provided in this website
                  </p>
                </article>
                {/* Block #3 */}
                <article className="dark:bg-darkCard dark:text-darkText p-4 rounded shadow-md">
