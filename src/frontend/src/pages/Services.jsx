            ...
            <div className='text-center my-8'>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
                    <div className="lg:w-1/4 flex flex-col md:py-28 py-23 justify-center lg:justify-start items-center text-center lg:items-start lg:text-left h-full">
                        ...
                        <p className="text-base text-black">A simple paragraph is comprised of 2 major components. The first sentence, which is often a declarative sentence, is called the topic sentence.</p>
                    </div>
