...
const Services = () => {
    ...
    return (
        <div className='md:px-14 px-4 py-16 max-w-screen-2xl mx-auto dark:bg-darkBg ' id="services">
            <div className='text-center my-8'>
                <h2 className='text-4xl font-semibold mb-2'>What languages do you want to learn?</h2>
                <p className='font-italic'> We provide learners with over 20+ languages with experienced teachers. </p>
                        ...
                        {carousels[currentCarouselIndex].map((slide, index) => (
                            <div key={index} className='h-96 p-5 items-center flex justify-center'>
                                <div>
                                    ...
                                    <h5 className='font-semibold px-5 text-center mt-5'>{slide.caption}</h5>
                                </div>
                            </div>
                        ))}
                    </Carousel>
                        ...
                        <div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 items-start md:gap-12 gap-8'>
                            <div className='bg-[rgba(255, 255, 255, 0.04)] dark:bg-darkCard rounded-[35px] h-96 shadow-3xl p-8 items-center flex justify-center hover:-translate-y-4 transition-all duration-300 cursor-pointer'>
                                <div>
                                    ...
                                    <h5 className='text-2xl font-semibold px-5 text-center mt-5 dark:text-darkText'>Access to learning documents</h5>
                                </div>
                            </div>
                            <div className='bg-[rgba(255, 255, 255, 0.04)] dark:bg-darkCard rounded-[35px] h-96 shadow-3xl p-8 items-center flex justify-center hover:-translate-y-4 transition-all duration-300 cursor-pointer md:mt-16'>
                                <div>
                                    ...
                                    <h5 className='text-2xl font-semibold px-5 text-center mt-5 dark:text-darkText'>Connect with fellow learners</h5>
                                </div>
                            </div>
                            <div className='bg-[rgba(255, 255, 255, 0.04)] dark:bg-darkCard rounded-[35px] h-96 shadow-3xl p-8 items-center flex justify-center hover:-translate-y-4 transition-all duration-300 cursor-pointer'>
                                <div>
                                    <img src={b3} alt="Online meeting with teacher" />
                                    <h5 className='text-2xl font-semibold px-5 text-center mt-5 dark:text-darkText'>Online meeting with teacher</h5>
                                </div>
                            </div>
                        </div>
                    </div>
