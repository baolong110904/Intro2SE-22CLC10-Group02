...
const Recruitment = () => {
  return (
    <div className="md:px-14 p-4 max-w-s mx-auto py-10" id="recruitment">
      ...
      ">
        ...
        <article className="bg-white p-6 rounded-lg shadow-2xl">
          <header className="mb-2">
            <img className="inline-flex rounded-full shadow mb-3" src="/G2Learning.svg" width="44" height="44" alt="Icon" />
