...
export function ParticipantView({ participantId }) {
  ...
  const getAvatarUrl = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/users/avatar`, {
        headers: {
          "Content-Type": "application/json",
          "X-Auth-User-Email": localStorage.getItem("email"),
        },
      })
      ...
      return "https://res.cloudinary.com/ds9macgdo/image/upload/v1719592662/g2/avatar/default.png"
    }
  }
    ...
    >
      ...
      {webcamOn ? (
        ...
        <div className="h-full w-full flex items-center justify-center">
          ...
          <img
            src={getAvatarUrl()}
            // src="https://res.cloudinary.com/ds9macgdo/image/upload/v1719592662/g2/avatar/default.png"
            alt={`${displayName}'s avatar`}
            className="z-10 rounded-full 2xl:h-[92px] h-[52px] 2xl:w-[92px] w-[52px] object-cover justify-center items-center"
            onError={(e) => {
              e.target.onerror = null
              e.target.src =
                "https://res.cloudinary.com/ds9macgdo/image/upload/v1719592662/g2/avatar/default.png"
            }}
          />
        </div>
      )}
