...
import { Box, Grid, Button, Typography, TextField, MenuItem, Select, FormControl } from "@mui/material";
                                    ...
                                    {cart.map((item) => (
                                        <li key={item.id} className="cart-item">
                                            ...
                                            <div className="cart-item-info">
                                                ...
                                                <span className="course-price">${item.price.toFixed(2)}</span>
                                            </div>
                                            <button onClick={() => handleRemoveFromCart(item.id, email)} className="remove-cart-button">
                                                Remove
                                            </button>
                                        </li>
                                    ))}
