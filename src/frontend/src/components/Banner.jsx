...
const Banner = () => {
    return (
        <div className="p-4 max-w-screen-2xl mx-auto mt-27 h-screen">
            <div className='gradientBg rounded-xl rounded-br-[80px] md:p-9 px-2 py-9 h-full'>
                <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto h-full'>
                    <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12 h-full">
                        ...
                        <h1 className='animate-slidein300 opacity-0 text-3xl md:text-4xl font-extrabold [text-wrap:balance] leading-relaxed'>Learn a new <span class="text-green-100 inline-flex flex-col h-[calc(theme(fontSize.3xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.4xl)*theme(lineHeight.tight))] overflow-hidden">
