        ...
        <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto h-full">
          <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12 h-full">
            ...
            <div className="text-black md:w-2/3 text-left">
              <h1 className="animate-slidein300 opacity-0 text-3xl md:text-4xl font-extrabold [text-wrap:balance] leading-relaxed">
                Learn a new{" "}
                <span className="text-green-100 inline-flex flex-col h-[calc(theme(fontSize.3xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.4xl)*theme(lineHeight.tight))] overflow-hidden">
              ...
              <p className="animate-slidein500 opacity-0 text-white md:text-xl mt-8 mb-5">
                In the world where global integration has risen to unprecedented
                heights, the ability to communicate across cultures has become
                essential. Let's unlock the world of language together!
              </p>
              <br />
